...
/**
 * Tampa Bay Hair Salon / Hairdresser Lead Harvester
 *
 * Targets solo stylists, hair salons, and barbershops in the Tampa Bay area.
 *
 * Usage:
 *   php tools/harvest_hairdressers.php            # fresh run
 *   php tools/harvest_hairdressers.php --append   # add new results without overwriting
 *
 * Requirements:
 *   - GOOGLE_PLACES_API_KEY in .env
 *
 * Output:
 *   tools/hairdresser_leads.csv
 */
...
define('OUTPUT',  __DIR__ . '/hairdresser_leads.csv');
...
$queries = [
    'hair salon Tampa FL',
    'hair salon St. Petersburg FL',
    'hair salon Clearwater FL',
    'hair salon Brandon FL',
    'hair salon Wesley Chapel FL',
    'hair salon Sarasota FL',
    'hair salon Lakeland FL',
    'hair salon Bradenton FL',
    'barbershop Tampa FL',
    'barbershop St. Petersburg FL',
    'hairdresser Tampa FL',
    'hair stylist Tampa FL',
    'beauty salon Tampa FL',
    'natural hair salon Tampa FL',
    'hair color salon Tampa FL',
];
...
$places = [];
echo "Searching Google Places for hair salons + stylists…\n";
