...
/**
 * Tampa Bay Small Landlord Lead Harvester
 *
 * Targets individual landlords and small rental operators (NOT large property
 * management companies) in the Tampa Bay area.
 *
 * Usage:
 *   php tools/harvest_landlords.php            # fresh run
 *   php tools/harvest_landlords.php --append   # add new results without overwriting
 *
 * Requirements:
 *   - GOOGLE_PLACES_API_KEY in .env
 *
 * Output:
 *   tools/landlord_leads.csv
 */
...
define('OUTPUT',  __DIR__ . '/landlord_leads.csv');
...
$queries = [
    'apartment rental Tampa FL',
    'apartment rental St. Petersburg FL',
    'apartment rental Clearwater FL',
    'houses for rent Tampa FL',
    'houses for rent Brandon FL',
    'houses for rent Wesley Chapel FL',
    'rental homes Hillsborough County FL',
    'rental homes Pinellas County FL',
    'landlord rental Tampa FL',
    'small apartment complex Tampa FL',
    'duplex rental Tampa FL',
    'private landlord Tampa FL',
];
...
$places = [];
echo "Searching Google Places for small landlords…\n";
